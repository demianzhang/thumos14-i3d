...
## Feature Extraction
[extract_features.py](extract_features.py) contains the code to load a pre-trained I3D model and extract the features and save the features as numpy arrays. The [thumos_dataset_not_fixed.py](thumos_dataset_not_fixed.py) script loads an entire video to extract per-segment features.
